...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" pc>
                    <a class="onFullScreen" href="javascript:;" id="view-fullscreen"><i class="iconfont icon-loginout"></i> 全屏</a>
                </li>
    ...
    <div class="layui-footer footer">
        <p>copyright @2017 请叫我涛哥　　<a onclick="donation()" class="layui-btn layui-btn-danger l·ayui-btn-small">捐赠作者</a></p>
    </div>
</div>
